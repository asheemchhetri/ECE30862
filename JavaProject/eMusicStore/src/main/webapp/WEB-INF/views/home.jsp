        ...
        <div class="item active">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h1>Welcome to ECE 30862 Music Store</h1>
...
<div class="container marketing">
    ...
    <div class="row">
        <div class="col-lg-4">
            <img class="img-circle" src="<c:url value="/resources/images/endImg.jpg" />" alt="Generic placeholder image" width="140" height="140">
            <h2>Heading</h2>
